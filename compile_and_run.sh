...
./compile ../../src/ ../../blobs/ -o boot -s 2M -Q
qemu-system-i386 -no-kvm -monitor stdio -d guest_errors -m 3 -boot a -drive format=raw,if=none,file=BOOT_FLP.IMG -device floppy,drive=none0,drive-type=144
