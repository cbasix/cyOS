...
# boot via iso image
./compile ../../src/ ../../blobs/ -o raw -s 32M -Q -I 6 -t ia32 -T nsop -D code addr.txt -D sym syminfo.txt -u raw  # gc null ptr ;) with rte ->nullptr
...
qemu-system-i386 -m 32 -cdrom cyos.iso -no-kvm -monitor stdio -d guest_errors -netdev socket,id=cynet,listen=:1409 -device virtio-net-pci,netdev=cynet -object filter-dump,id=id,netdev=cynet,file=cynet.dmp
